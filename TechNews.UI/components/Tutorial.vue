...
<template>
  <div class="relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0">
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div id="mainSSS" class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
...
<style scoped>
/* #mainSSS {
  background-image: url("https://www.incimages.com/uploaded_files/image/1920x1080/getty_178098899_81139.jpg");
} */
</style>
